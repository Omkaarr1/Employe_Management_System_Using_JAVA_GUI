...
class printCalculation implements ActionListener {
    ...
    printCalculation(String x) throws IOException {
        ...
        JLabel tax = new JLabel(
                "Tax Payable : " + " 0.3 % of Net Salay = " + (0.3 * ((0.05 * Integer.valueOf(input))) + ""));
        JLabel total = new JLabel("Total Income : " + (Integer.valueOf(input) + (0.05 * Integer.valueOf(input))
                + (0.3 * ((0.05 * Integer.valueOf(input))))));
